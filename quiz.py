...
def quiz_form():
    ...
    <html>
        ...
        <body>
            <h2>Привет, мой дорогой друг! Я рад приветствовать тебя на моём сайте викторин. На нём ты можешь выбрать викторину по теме из 3 предложенных школьных дисциплин, и таким образом, проверить, насколько обширны твои знания в данной теме. Для тебя я подготовил 3 викторины по темам: География, Математика и Русский язык. В каждой из них представлено 9 вопросов, в каждом из которых 4 варианта ответа, и только один верный. Помни, что всё на свете знать абсолютно невозможно, поэтому у каждого из нас есть право ошибиться. По окончанию викторины выведится твой результат.</h2>
