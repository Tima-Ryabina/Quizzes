...
def quiz_form():
    ...
    <html>
        ...
        <body>
            ...
            <p>Я рад приветствовать тебя на моём сайте викторин. На нём ты можешь выбрать викторину по теме из <b>3</b> предложенных <i>школьных дисциплин</i>, пройти её и, таким образом, проверить, насколько обширны твои знания в данной теме.</p>
            <p>Для тебя я подготовил викторины на следующие темы: <i>География</i>, <i>Математика</i> и <i>Русский язык</i>. В каждой из них представлено <b>9</b> вопросов, в каждом из которых <b>4</b> варианта ответа, и только один верный.</p> 
            <p>Помни, что всё на свете знать абсолютно невозможно, поэтому у каждого из нас есть право ошибиться. По окончанию викторины выведится твой результат.</p>
...
def result():
    ...
    <html>
        ...
        <body>
            <h2>Поздравляю!</h2>
            <p>Ты закончил прохождение викторины.</p>
            <p>Итак, Вот твой результат: Правильных ответов:</p>
        </body>
    </html>
    '''
